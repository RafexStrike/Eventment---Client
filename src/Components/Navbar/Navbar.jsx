...
const Navbar = () => {
    ...
    bidayPrithibi()
      ...
      .catch((error) => {
        ...
        Swal.fire({
          icon: "error",
          title: "Oops...",
          text: `An error has occurred! ${error}. Please try again.`,
        });
      });
  };
  ...
  const links = (
    <>
      ...
      <NavLink
        className={`nav-link ${!user ? "hidden" : ""}`}
        to="/createGroup"
      >
        Create Event
      </NavLink>
  ...
  return (
    // Full-width sticky background container
    <div className="sticky top-0 z-50 w-full bg-[#F3EDDC] shadow-sm">
